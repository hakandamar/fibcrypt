...
- Build/package changes should be checked against `setup.py`, which now declares version `1.1.0`, runtime dependency `pycryptodomex>=3.22.0`, Python `>=3.8`, and a 256-bit default KDF prime in `fibcrypt.kdf`.
